...
function EditarPerfil() {
  return (
    <div className="col-12 d-flex flex-wrap align-items-center justify-content-center py-4 px-lg-0">
      <div className="col-11 col-lg-10 bg-blue p-4 rounded d-flex flex-wrap align-items-end justify-content-center">
        ...
        <div className="col-12 d-flex flex-wrap align-items-center justify-content-center">
          ...
          <div className="col-12 text-center py-2">
            <button className="bg-orange rounded-pill border border-dark border-2 fw-bold px-4 py-1 button-editar">
              Alterar Imagem +
            </button>
          </div>
        </div>
        ...
        <div className="col-12 d-flex justify-content-end">
          <div className="col-12 col-sm-6 col-lg-4 col-xl-3 px-4">
            <button className="bg-orange rounded-pill border border-dark border-2 fw-bold px-4 py-1 w-100 button-editar">
              Editar Perfil
            </button>
          </div>
        </div>
