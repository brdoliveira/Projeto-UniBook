...
function CadastroImagem() {
  ...
  */
  const handleSubmit = (e) => {
    ...
    // Está retornando um Objeto Imagem tratar para pegar o "hash" da imagem   
    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="col-11 d-flex d-block d-lg-none">
          ...
          <div className="col-6 text-center">
            <button className="bg-orange rounded-pill border border-dark border-2 fw-bold px-4 py-1 button-cadastro" type="submit">
              Finalizar Cadastro
            </button>
          </div>
        </div>
