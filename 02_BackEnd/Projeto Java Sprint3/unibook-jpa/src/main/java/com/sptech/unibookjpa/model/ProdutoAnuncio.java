...
public class ProdutoAnuncio {
    ...
    public ProdutoAnuncio(String nomeProduto, String tipo, String isbn, String autor, String ilustrador, String edicao, double preco, String tradutor, int ano, int quantidade, String generoLiteral, Vendedor vendedor) {
    }
