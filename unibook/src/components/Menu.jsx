  ...
  render() {
    return (
      <>
          ...
          <div className="container-fluid">
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
                ...
                <li
                  className="nav-item rounded mx-1 li-menu"
                  hidden={this.state.logado}
                >
                ...
                <li
                  className="nav-item dropdown li-menu"
                  hidden={this.state.logado}
                >
                  <button
                ...
                <div
                  className="col-12 d-block d-lg-none py-2"
                  hidden={this.state.logado}
                >
                  <div
                  ...
                  >
                    ...
                    <div className="col-12">
                      <a
                        className="text-decoration-none a-menu"
                        href="/cadastro"
                      >
                ...
                >
                  ...
                  >
                    <li
                      className="col-12 rounded border border-white border-3 px-2 fw-bold text-center text-white py-2 li-menu my-1"
                      onClick={this.perfil}
                    >
        ...
        <Favoritos
          showFavoritos={this.state.showFavoritos}
          parentCallbackFavoritos={this.handleCallbackFavoritos}
        />
        <Carrinho
          showCarrinho={this.state.showCarrinho}
          parentCallbackCarrinho={this.handleCallbackCarrinho}
        />
      </>
    );
  }
